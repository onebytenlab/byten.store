...
function HeaderLogo({ siteSettings }: { siteSettings: SiteSettings }) {
  ...
  if (isHome) {
    return (
      <div style={{ display: "flex", flexDirection: "column", gap: "0.125rem" }}>
        <Logo width="190" height="40" text={siteSettings.title} />
        <span style={{ color: "#9ca3af", fontSize: "0.75rem", paddingLeft: "0.6rem" }}>{siteSettings.description}</span>
      </div>
    );
  }
...
export default function Header({ initialMenuItems, siteSettings }: HeaderProps) {
